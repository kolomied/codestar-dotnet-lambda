...
The project starts with ValuesController that is created by default for new ASP.NET Core Web API projects. 
...
Execute unit tests
```
    cd "CoreApiHelloWorld/test/CoreApiHelloWorld.Tests"
    dotnet test
```

Deploy application
```
    cd "CoreApiHelloWorld/src/CoreApiHelloWorld"
